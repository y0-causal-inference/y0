...
class TestDeDri(unittest.TestCase):
    ...
    def test_interval(self):
        ...
        self.assertTrue(a.is_met_by(d))
        self.assertFalse(d.is_met_by(d))
        self.assertTrue(a.overlaps_with(b))
        self.assertFalse(b.overlaps_with(b))
        self.assertTrue(b.is_overlapped_by(a))
        self.assertFalse(a.is_overlapped_by(b))
