...
from y0.dsl import Variable, X, Y, Z, W
...
def generate_data_for_frontdoor(
    ...
    if W in treatments:
        ...
        w = generator.normal(loc=40.0, scale=10.0, size=num_samples)
    ...
    if X in treatments:
        ...
        p = _r_exp(-beta0_x - w * beta_w_to_x)
    ...
    if Y in treatments:
        ...
        y = generator.normal(
            loc=100 * _r_exp(-beta0_y - z * beta_z_to_y - w * beta_w_to_y),
            scale=1,
            size=num_samples,
        )
