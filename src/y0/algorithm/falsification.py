...
def are_d_separated(G, a, b, *, given=None):
    ...
    class Result:
        ...
        def __bool__(self): return self.separated  # noqa: E704
        def __repr__(self): return f"{repr(self.separated)} ('{a}' d-sep '{b}' given {given})"  # noqa: E704
        def __eq__(self, other): return self.separated == other  # noqa: E704
...
def falsifications(G, df, significance_level=.05, max_given=None, verbose=False):
    class Evidence(abc.Sequence):
        ...
        def __getitem__(self, i): return self._failures[i]  # noqa: E704
        def __len__(self): return len(self._failures)  # noqa: E704
        def __repr__(self): return repr(self._failures) + "+evidence"  # noqa: E
