...
module Identification {
  ...
  // ==================================================================
  // 1.1  Executable ID IR Surface (Split-Out)
  //
  // The executable, extraction-oriented ID surface has been moved to:
  //   src/dafny/identification_executable_core.dfy
  //
  // This file now focuses on theorem/spec content and intentionally keeps
  // axiom-bearing material separated from the axiom-free executable core.
  // ==================================================================
