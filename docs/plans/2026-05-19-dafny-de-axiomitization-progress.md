...
| DA-P5-001 | P5 | Decide concrete finite-sum design for `ProbEvent` or document why it remains abstract. | Planned | Architectural decision before probability burn-down. | Documentation or targeted Dafny verify. | `docs(dafny): decide probability finite-sum proof path` |
...
| 2026-05-20 | Working tree | 88 | 19 | 69 | -1 declaration axiom | `DSep_Intersection` is now proved in the working tree. |
...
| DA-P4-009 | `proof(dafny): prove d-separation intersection` | Replace the `DSep_Intersection` axiom with a direct alternating-prefix descent proof and update the progress tracker / axiom ledger. | Focused `dag.dfy` verify plus full-stack verify. | Ready |
